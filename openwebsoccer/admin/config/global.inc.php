...
if (isset($conf)) {
	if (file_exists('install')){
		echo '<center>Das Installationsverzeichnis ist noch vorhanden ! - Unbedingt lÃ¶schen !</center><br>';
	}
	if (file_exists('update')){
		echo '<center>Das Update-Installationsverzeichnis ist noch vorhanden ! - Update ausfÃ¼hren und dann lÃ¶schen bzw. Unbedingt lÃ¶schen !</center><br>';
	}
}
