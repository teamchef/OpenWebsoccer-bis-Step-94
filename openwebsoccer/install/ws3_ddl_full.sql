...
('Elfmeter_erfolg','<b>{ma1} : </b>Laute Pfiffe doch {sp1} macht das souverän, wie er den Ball unten in die Ecke schiebt.</b>'),
...
('Torschuss_auf_Tor','<b>{ma1} : </b>Blitzschneller Konter der {ma1}. {sp1} schaltet schnell, schickt {sp2} der aber nur ein harmloses Schüsschen abgibt.'),
